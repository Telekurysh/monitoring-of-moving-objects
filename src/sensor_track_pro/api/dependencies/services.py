...
from src.sensor_track_pro.data_access.repositories.telemetry_repo import TelemetryRepository
...
def get_telemetry_service(session: AsyncSession = db_dep) -> TelemetryService:
